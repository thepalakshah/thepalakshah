...
- 🌱 Passionate about **PyTorch**, **Computer Vision**, **CNN Architectures**, **AI Research**, **ML Algorithms**, **Data Preprocessing**, **Feature Engineering**, **Model Deployment**,<br>**scalable REST APIs**, and building intelligent, efficient software solutions that bridge **AI and Full Stack systems**.
